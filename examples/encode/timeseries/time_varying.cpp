...
int main(int argc, char** argv)
{
    ...
    const int   dom_dim     = 4;            // dimension of domain (<= pt_dim)
    const int   structured  = 1;            // input data format (bool 0/1)

    // default command line arguments
    int         pt_dim      = 5;            // dimension of input points
    ...
    string      input       = "tornado4d";  // input dataset
    ...
    echo_mfa_settings("time_varying example", dom_dim, pt_dim, scalar, geom_degree, geom_nctrl, vars_degree, vars_nctrl,
