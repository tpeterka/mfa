//--------------------------------------------------------------
// example of encoding / decoding 2D gridded data sets read from
// a file
//
// David Lenz
...
int main(int argc, char** argv)
{
    ...
    const int dom_dim     = 2;        // dimension of domain (<= pt_dim)
    ...
    echo_mfa_settings("gridded_2d example", dom_dim, pt_dim, scalar, geom_degree, geom_nctrl, vars_degree, vars_nctrl,
