...
int main(int argc, char **argv) {
    ...
    std::vector<int> resolutions; // will be different resolutions per direction
    resolutions.push_back(20);
    resolutions.push_back(20);
    resolutions.push_back(20); // default
    int starts[3] = { 0, 0, 0 };
    ...
    ops >> opts::Option('u', "resolution", resolutions,
                    " number of output points in each direction of domain");
    ...
    // keep the first block blend , to be able to compare with the old method
    master.foreach([&](Block<real_t> *b, const diy::Master::ProxyWithLink &cp) {
