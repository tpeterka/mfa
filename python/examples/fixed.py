...
mfa_info = mfa.MFAInfo(dom_dim, 1)
geom_model_info = mfa.ModelInfo(dom_dim, dom_dim, geom_degree, geom_nctrl_pts)
...
d.decompose(
    w.rank,
    a,
    lambda gid, core, bounds, domain_, link: mfa.Block.add(
        gid, core, bounds, domain_, link, m, dom_dim, pt_dim
    ),
)
